...
function rcl_fields_manager_scripts() {
	rcl_enqueue_style( 'rcl-fields-manager', RCL_URL . 'modules/fields-manager/style.css' );
	rcl_enqueue_script( 'rcl-fields-manager', RCL_URL . 'modules/fields-manager/scripts.js' );
}
