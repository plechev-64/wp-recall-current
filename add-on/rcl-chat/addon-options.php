	...
	$content .= $opt->options(
		...
		$opt->options_box(
			...
			array(
				...
				'value_max'	 => 20,
				'default'	 => 5,
				'notice'	 => __( 'Specify a number of users, who other user will be able to send an unread private message for a day. '
					. 'If its value is exceeded the sending of messages will be blocked.', 'wp-recall' )
			),
			array(
				'type'		 => 'runner',
