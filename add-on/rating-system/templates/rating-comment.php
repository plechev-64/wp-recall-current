...
<div class="rating-single">
    ...
    <div class="rating-sidebar">
        <a title="<?php echo get_the_author_meta( 'display_name', $rating->object_author ); ?>"
           href="<?php echo rcl_get_user_url( $rating->object_author ); ?>">
    ...
    <div class="rating-meta">
        <p>
            ...
            <span class="comm-more"><a href="<?php echo get_comment_link( $rating->object_id ); ?>"
                                       title="<?php _e( 'Go to comment', 'wp-recall' ) ?>"><i
