...
echo '<h4>' . __( 'RCLKEY', 'wp-recall' ) . '</h4>
    ...
    <p class="install-help">' . __( 'Required to update the templates here. Get it  in  your account online <a href="https://codeseller.ru/" target="_blank">http://"codeseller.ru</a>', 'wp-recall' ) . '</p>';
